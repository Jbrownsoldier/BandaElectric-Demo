...
export function AboutPage() {
  return (
    <>
      <SEO
        title="About Banda Electric | Lethbridge Electrical Contractor"
        description="Learn about Banda Electric, a Lethbridge-owned electrical contractor serving Southern Alberta with industrial, residential, agricultural, and commercial electrical work."
        canonical="/about"
      />
        ...
        <section className="relative overflow-hidden py-32 px-6 lg:px-8 border-b border-white/5">
          ...
          <div className="max-w-5xl mx-auto relative z-10text-center flex flex-col items-center">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-black text-white leading-none tracking-tighter mb-8 uppercase text-center">
              Local <br/><span className="text-secondary bg-clip-text text-transparent bg-gradient-to-r from-secondary to-yellow-600">Experience.</span>
            </h1>
            <p className="text-slate-300 text-lg md:text-xl max-w-2xl leading-relaxed text-center">
              Banda Electric is a Lethbridge-owned electrical contractor built around quality workmanship, quick turnaround, and practical solutions for Southern Alberta projects of every size.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 flex justify-center lg:justify-start">
              <div className="relative w-full aspect-square max-w-[500px]">
                ...
                <img
                  ...
                  alt="Banda Electric team on site"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-slate-400 mb-6 leading-relaxed">
                Banda Electric is built around highly trained, industry-certified electricians who approach every job with an eye for quality, strong planning, and straightforward execution.
              </p>
              <p className="text-slate-400 mb-8 leading-relaxed">
                The company serves industrial, residential, agricultural, and commercial clients throughout Southern Alberta, with two master electricians, 40+ years of combined experience, and a five-year warranty behind the work.
              </p>

              <ul className="space-y-4 font-headline uppercase tracking-widest text-sm font-bold">
                <li className="flex items-center gap-3 text-white">
                  <CheckCircle2 className="w-5 h-5 text-secondary" />
                  Lethbridge owned and operated
                </li>
                <li className="flex items-center gap-3 text-white">
                  <CheckCircle2 className="w-5 h-5 text-secondary" />
                ...
                <li className="flex items-center gap-3 text-white">
                  <CheckCircle2 className="w-5 h-5 text-secondary" />
                  Safety-first workmanship with a five-year warranty
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="flex-1 lg:pr-12">
                  ...
                  <div className="flex items-center gap-6">
                      <div className="bg-surface/50 border border-white/10 rounded-lg p-4 flex-1">
                          ...
                          <div className="font-headline font-bold text-white uppercase text-xs mb-1">2 Master Electricians</div>
                          <div className="text-slate-500 text-xs">40+ years combined</div>
                      </div>
                  </div>
              </div>

              <div className="w-full lg:w-[400px] shrink-0">
                  <div className="bg-surface border border-secondary/30 p-8 rounded-xl shadow-[0_0_30px_rgba(246,255,3,0.05)] relative">
