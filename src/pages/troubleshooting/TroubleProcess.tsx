...
"Share what is happening at the property, what systems are affected, and whether this is an emergency, a maintenance concern, or a planned site requirement like line location.",
 ...
 description:
"Urgent issues are prioritized through Banda Electric's 24-hour phone service, while planned service requests are scoped so the visit and next steps fit the site conditions.",
...
"We assess the real cause of the issue, the condition of the electrical system, and whether the best solution is repair, preventative maintenance, or a larger upgrade plan.",
 ...
 description:
"Banda Electric's contact process emphasizes detailed, experience-backed quoting. You get a practical explanation of the work and the recommended next step before the field scope moves forward.",
...
export function TroubleProcess() {
 ...
 'Repairs backed by Banda Electric warranty support',
 ].map((item) => (
